<template>
  <div class="layout-content violation-level">
    <el-card class="box-card">
      ...
      >
        <el-table-column
          ...
          align="left"
        />
        <el-table-column label="违章程度" prop="ruleTypeId" />
        <el-table-column label="违章扣分" prop="armName" width="250px" show-overflow-tooltip />
      ...
      >
        ...
        >
          <el-row>
            <el-col :span="24">
              <el-form-item label="违章程度:" prop="armName">
                <el-input v-model="input" placeholder="placeholder" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="违规扣分:" prop="score">
                <el-input
                  v-model.number="createFormData.score"
                >
  ...
  data() {
    return {
      ...
      rules: {
        ...
        score: [{ required: true, message: '请输入分值', trigger: 'blur' }, { type: 'number', message: '只能输入数字' }],
