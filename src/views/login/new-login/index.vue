    ...
    <!-- <div class="tyg-div-denglv">
      <div class="tyg-div-form">
        <form action="">
          ...
          <button type="submit">登<span style="width:20px;" />录</button>
        </form>
      </div>
    </div> -->
  </div>
...
export default {
  ...
  methods: {
    ...
    //   $(document).ready(function() {
      ...
      //     : a.which == 38 && mainObj.suffix != 0 && mainObj.scroll_To(mainObj.getNextSuffix(!1))
      // })
    //   })
