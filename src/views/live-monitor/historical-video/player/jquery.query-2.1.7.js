...
new function(settings) {
  ...
  var $spaces = settings.spaces !== false
  var $suffix = settings.suffix === false ? '' : '[]'
  var $prefix = settings.prefix !== false
  var $hash = $prefix ? settings.hash === true ? '#' : '?' : ''
  var $numbers = settings.numbers !== false
  ...
  jQuery.query = new function() {
    ...
    var parse = function(path) {
      var m; var rx = /\[([^[]*)\]/g; var match = /^([^[]+)(\[.*\])?$/.exec(path); var base = match[1]; var tokens = []
      while (m = rx.exec(match[2])) tokens.push(m[1])
      return [base, tokens]
    }
    var set = function(target, tokens, value) {
      var o; var token = tokens.shift()
    ...
    queryObject.prototype = {
      ...
      GET: function(key) {
        ...
        var parsed = parse(key); var base = parsed[0]; var tokens = parsed[1]
      ...
      toString: function() {
        var i = 0; var queryString = []; var chunks = []; var self = this
